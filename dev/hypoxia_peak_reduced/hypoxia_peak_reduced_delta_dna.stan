...
transformed parameters {
  ...
  for (n in 1:N) {
    ...
    mu_g1_2n[n] = mu_cen[n] * phi_date[date_id[n]] * R_2n * distortion * delta_dna_multiplier[n];
    mu_g1_4n[n] = mu_cen[n] * phi_date[date_id[n]] * R_4n * distortion * delta_dna_multiplier[n];
  }
}
