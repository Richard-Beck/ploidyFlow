...
transformed parameters {
  ...
  for (n in 1:N) {
    ...
    mu_peak_2n[n] = mu_cen[n] * phi_date[date_id[n]] * R_2n * distortion;
    mu_peak_4n[n] = mu_cen[n] * phi_date[date_id[n]] * R_4n * distortion;
    mu_peak_8n[n] = mu_cen[n] * phi_date[date_id[n]] * R_8n * distortion;
  }
}
